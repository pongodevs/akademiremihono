...
export const reactionsCreate = async (c: Context<{ Bindings: CloudflareBindings }>) => {
    const db = c.env.DB
    ...
    return new Response(JSON.stringify({ succes: true, message: `Successfully migrate ${email}` }), { 
        status: 200,
        headers: {
