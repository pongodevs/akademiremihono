/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 8695fe1873e99d720c92893a33212beb)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ASSETS: Fetcher;
		X_API_KEY: string;
		PUBLIC_X_API_KEY: string;
		KOMA_X_API_KEY: string;
		...
		SB_MIDTRANS_SERVER_KEY: string;
		SB_MIDTRANS_CLIENT_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "X_API_KEY" | "PUBLIC_X_API_KEY" | "KOMA_X_API_KEY" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "STORAGE_ENDPOINT" | "RESEND_API_KEY" | "JWT_KEY" | "MIDTRANS_SERVER_KEY" | "MIDTRANS_CLIENT_KEY" | "SB_MIDTRANS_SERVER_KEY" | "SB_MIDTRANS_CLIENT_KEY" | "COMFYICU_API_KEY">> {}
}
